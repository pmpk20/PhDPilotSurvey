...
# Estimate model:
apollo_control = list(
  modelName  = "Q6ICLV_2022_03_21",
  modelDescr = "Q6ICLV_2022_03_21",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 10,
  noValidation=TRUE)
...
Q6ICLV_2022_03_21 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(Q6ICLV_2022_03_21,modelOutput_settings = list(printPVal=TRUE))
xtable::xtable(round(data.frame(apollo_modelOutput(Q6ICLV_2022_03_21,modelOutput_settings = list(printPVal=TRUE))),3),digits=3)

Q6ICLV_2022_03_21_UCWTP <- apollo_unconditionals(Q6ICLV_2022_03_21,apollo_probabilities,apollo_inputs)
Q6ICLV_2022_03_21_ConWTP <- apollo_conditionals(Q6ICLV_2022_03_21,apollo_probabilities,apollo_inputs)

saveRDS(Q6ICLV_2022_03_21,"Q6ICLV_2022_03_21.rds")
saveRDS(Q6ICLV_2022_03_21_UCWTP,"Q6ICLV_2022_03_21_UCWTP.rds")
saveRDS(Q6ICLV_2022_03_21_ConWTP,"Q6ICLV_2022_03_21_ConWTP.rds")
# Q6ICLV_2022_03_21 <- readRDS("Q6ICLV_2022_03_21.rds")

# WTP:
# Model <- Q6ICLV_2022_03_21
...
# Q6ICLV_2022_03_21WTP <- median(-Model$estimate["intercept"]+CVunconditionals7F$LV/Model$estimate["b_bid"])
